public class DoubleLinkedLists16 {
    ...
    public void addLast(int item, int jarak){
        if (isEmpty()) {
            ...
            Node16 newNode = new Node16 (current, item, jarak, null);
    ...
    public void add(int item, int index, int jarak) throws Exception{
        if (isEmpty()) {
            ...
            if (current.prev == null) {
                Node16 newNode = new Node16(null, item, jarak, current);
                current.prev = newNode;
                head = newNode;
            }else{
                Node16 newNode = new Node16(current.prev, item, jarak, current);
    ...
    public void updateJarak(int data, int newJarak) throws Exception {
        if (isEmpty()) {
            throw new Exception("Linked List kosong.");
        }
        Node16 tmp = head;
